...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler,LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int SUNSHINE_LOADER_ID = 473;
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
         getSupportLoaderManager().initLoader(SUNSHINE_LOADER_ID, bundleForLoader, callback);
    }
    ...
    */
    ...
    public Loader<String[]> onCreateLoader(int id,final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            @Override
            public void deliverResult(String[] resultData) {
                mWeatherData = resultData;
                super.deliverResult(resultData);
            }
        };
