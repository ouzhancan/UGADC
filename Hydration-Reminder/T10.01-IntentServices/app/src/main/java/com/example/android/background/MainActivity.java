...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent incerementWaterCountIntent = new Intent(MainActivity.this,WaterReminderIntentService.class);

        // COMPLETED (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        incerementWaterCountIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        // COMPLETED (17) Call startService and pass the explicit intent you just created
        startService(incerementWaterCountIntent);
    }
