...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ){
            ...
            int batteryExtra = batteryStatus.getExtras().getInt(BatteryManager.EXTRA_STATUS);

            if(batteryExtra == BatteryManager.BATTERY_STATUS_FULL || batteryExtra == BatteryManager.BATTERY_STATUS_CHARGING){
                isCharging = true;
            }
