...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.mViewHoldeIndexTextView.setText("ViewHolder index : "+viewHolderCount);
        ...
        viewHolderCount++;
        Log.d(TAG,"View Holder Count : "+String.valueOf(viewHolderCount));
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView mViewHoldeIndexTextView;
        ...
        public NumberViewHolder(View itemView) {
            ...
            mViewHoldeIndexTextView = (TextView)itemView.findViewById(R.id.tv_view_holder_instance);
        }
