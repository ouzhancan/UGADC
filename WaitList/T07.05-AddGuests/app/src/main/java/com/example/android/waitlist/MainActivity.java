...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewPartSizeEditText = (EditText)findViewById(R.id.party_count_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        if(mNewPartSizeEditText.length()<=0 ||
        ...
        try {
            ...
            partySize = Integer.parseInt(mNewPartSizeEditText.getText().toString());
        ...
        mNewPartSizeEditText.clearFocus();
        mNewGuestNameEditText.getText().clear();
        mNewPartSizeEditText.getText().clear();
